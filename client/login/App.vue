<template>
    <div>
        <pull :pullConfig="options">
            ...
            <div class="loader" v-if="app.isLoading">
...
<script>
import pull from '../index/components/pull.vue'
...
export default {
        ...
        return {
            options: {
                ...
                pullDownDone() {
                    this.suc = false
                    setTimeout(() => {
                        console.log('down', this.suc)
                        this.suc = true
                        console.log('downen', this.suc)
                    }, 3000)
                },
            },
            selectedCity: '2357536',
            selectedCities: '',
            selectOptions: [
    ...
    methods: {
        ...
        getForecast(key, label) {
            ...
            this.$http(url)
                .then((res) => {
                    console.log('客户端获取数据完成, 用时', new Date().getTime() - t1, 'mm');
                    console.log('res', res);
        ...
        addCity() {
            ...
            const label = this.cityCodeToName[key];
...
.header #butRefresh {
    background: url(../index/assets/images/ic_refresh_white_24px.svg) center center no-repeat;
}

.header #butAdd {
    background: url(../index/assets/images/ic_add_white_24px.svg) center center no-repeat;
}
...
.weather-forecast .icon.clear-day {
    background-image: url("../index/assets/images/clear.png");
}
...
.weather-forecast .icon.rain {
    background-image: url("../index/assets/images/rain.png");
}

.weather-forecast .icon.snow {
    background-image: url("../index/assets/images/snow.png");
}

.weather-forecast .icon.sleet {
    background-image: url("../index/assets/images/sleet.png");
}

.weather-forecast .icon.windy {
    background-image: url("../index/assets/images/wind.png");
}

.weather-forecast .icon.fog {
    background-image: url("../index/assets/images/fog.png");
}

.weather-forecast .icon.cloudy {
    background-image: url("../index/assets/images/cloudy.png");
}

.weather-forecast .icon.partly-cloudy-day {
    background-image: url("../index/assets/images/partly-cloudy.png");
}
...
.weather-forecast .icon.thunderstorms {
    background-image: url("../index/assets/images/thunderstorm.png");
}
